APPROACH 1 : Generate all possible combos(permutations) then find the nums array,
return its next permutation & if last nums is found the n first permutation is its next permutation.
  T.C. -> O(n! * n)
